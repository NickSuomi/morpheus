...
```sh
curl -fsSL https://github.com/NickSuomi/morpheus/releases/latest/download/install.sh | MORPHEUS_VERSION=0.1.20 sh
```
...
```sh
scripts/package-release.sh --version 0.1.20 --only-os darwin --only-arch arm64
```
